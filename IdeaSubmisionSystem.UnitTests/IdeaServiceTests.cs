...
public class IdeaServiceTests
{
    ...
    public IdeaServiceTests()
    {
        ...
        {
            cfg.CreateMap<IdeaSubmisionSystem.Domain.Entities.Idea, IdeaDto>().ReverseMap();
        });
    ...
    {
        // Arrange
        var ideas = new List<IdeaSubmisionSystem.Domain.Entities.Idea>
{
new IdeaSubmisionSystem.Domain.Entities.Idea { Id = 1, Title = "Idea 1", Message = "Message 1" },
new IdeaSubmisionSystem.Domain.Entities.Idea { Id = 2, Title = "Idea 2", Message = "Message 2" }
};
    ...
    {
        // Arrange
        var idea = new IdeaSubmisionSystem.Domain.Entities.Idea { Id = 1, Title = "Idea 1", Message = "Message 1" };
    ...
    public async Task AddAsync_ShouldCallRepositoryAdd()
    {
        ...
        // Assert
        _ideaRepositoryMock.Verify(repo => repo.AddAsync(It.IsAny<IdeaSubmisionSystem.Domain.Entities.Idea>()), Times.Once);
    }
    ...
    public async Task UpdateAsync_ShouldCallRepositoryUpdate()
    {
        ...
        // Assert
        _ideaRepositoryMock.Verify(repo => repo.UpdateAsync(It.IsAny<IdeaSubmisionSystem.Domain.Entities.Idea>()), Times.Once);
    }
